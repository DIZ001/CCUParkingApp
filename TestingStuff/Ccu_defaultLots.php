...
*/
	...
	try {
		...
		$jsondata = file_get_contents('CcuLots.json');
		
		//convert json object to php associative array
		$data = json_decode($jsondata, true);
		
		//get the parking lot details
		$lotName = $data['parkingLots']['lotName'];
		$vehiclesEntered = $data['parkingLots']['vehiclesEntered'];
		$vehiclesExited = $data['parkingLots']['vehiclesExited'];
		$numGenSpots = $data['parkingLots']['numGenSpots'];
		$numFacStaffSpots = $data['parkingLots']['numFacStaffSpots'];
		$numHandiSpots = $data['parkingLots']['numHandiSpots'];
